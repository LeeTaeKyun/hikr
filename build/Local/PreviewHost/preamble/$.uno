...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.0.27"), 12124)}, "C:\\Users\\Administrator\\Documents\\Fuse\\hikr\\hikr.unoproj", GetBundle, new string[] { ""})
{
